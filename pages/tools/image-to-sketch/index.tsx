...
const ImageToSketch: React.FC = () => {
  ...
  const sampleImages = [
    { src: "/sketches/sketch22.webp", alt: "Coin" },
    { src: "/sketches/girl.jpeg", alt: "Portrait 1" },
    { src: "/sketches/sketch16.webp", alt: "Phone" }
  ];
  ...
  const handleStartAll = async () => {
    if (selectedFile || selectedSampleImage) {
      ...
      try {
        const response = await axios.post('http://localhost:8000/sketch', formData, {
          headers: {
    ...
    <div>
      ...
      <div className="mx-auto max-w-screen-md">
        <div className="flex justify-center mt-6">
          <Image src={logo} alt="Sketch Logo" width={100} height={100} /> {/* Display the logo */}
        </div>
        ...
        <p className="mb-8 text-base font-light flex justify-center text-gray-500">
          Convert your JPG, PNG images into sketch form.
        </p>

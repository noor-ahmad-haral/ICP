...
const ImageToSepia: React.FC = () => {
  ...
  const handleStartAll = async () => {
    if (selectedFile || selectedSampleImage) {
      ...
      try {
        const response = await axios.post('http://localhost:8000/sepia', formData, {
          headers: {
    ...
    <div>
      ...
      <div className="mx-auto max-w-screen-md">
        ...
        <p className="mb-8 text-base font-light flex justify-center text-gray-500">
          Convert your JPG, PNG images into sepia tones.
        </p>
        ...
        {/* Integrating the FAQ component here */}
        <div className="mt-12">
          <FAQ />
        </div>
      </div>
